    ...
    return (
        <div className="relative flex flex-col items-center justify-between space-y-3 p-4 md:flex-row md:space-x-4 md:space-y-0">
            ...
            <div className="flex w-full flex-shrink-0 flex-col items-stretch justify-end space-y-2 md:w-auto md:flex-row md:items-center md:space-x-3 md:space-y-0">
                <TableSearch />
                <Link to='create' className="flex items-center gap-1 justify-center rounded-lg bg-dark-blue-500 px-4 py-2 text-sm font-medium text-white focus:outline-none">
