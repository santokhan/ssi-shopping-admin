            ...
            <div className="w-full space-y-8">
                ...
                <form className="mt-4 space-y-4" onSubmit={handleForgot}>
                    <div className='space-y-2'>
                        <label htmlFor="email" className='text-start font-medium block'>Enter email</label>
                        <input
                            type="email"
                            name="email"
                            id="email"
                    ...
                    <div className="">
                        <button className="w-full rounded-md bg-dark-blue-500 hover:bg-dark-blue-400 px-12 py-3 text-sm font-medium text-white transition hover:bg-opacity-90 lg:text-base">
                            Reset<ArrowUpRightIcon className="inline-block ml-2 h-5 w-5" />
                        </button>
                    </div>
                    <p className="font-medium text-gray-800">Go to <a href="/signin" className="text-dark-blue-500 hover:text-dark-blue-400 inline-block text-base hover:underline">Sign In</a></p>
                </form>
            </div>
        </div>
    );
