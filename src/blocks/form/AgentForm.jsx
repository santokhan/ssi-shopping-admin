...
const AgentForm = () => {
    ...
    function onSubmit(e) {
        ...
        if (validateInput()) {
            ...
            api.post('agents/create/', formData, {
                headers: {
        ...
        <div className="bg-white rounded-xl p-4 lg:p-6">
            <ResponsiveForm onSubmit={onSubmit} className='!mt-0'>
                <InputBox className={"col-span-full pb-2"}>
                    ...
                    <AgentImageInput
                        src={imageUrl}
                        onChangeImage={(file) => { console.log(file) }}
                    />
                </InputBox>
                <Input
                ...
                <Input
                    ...
                    maxLength={14}
                    onChange={(e) => {
                        setValue(inputs.phone, e.target.value.replace(/\+/g, '').replace(/[^+\d]/g, ''));
                    }}
                    error={error.phone}
                />
                <Input
                ...
                <Input
                    ...
                    maxLength={14}
                    onChange={(e) => {
                        setValue(inputs.whatsapp_number, e.target.value.replace(/\+/g, '').replace(/[^+\d]/g, ''));
                    }}
