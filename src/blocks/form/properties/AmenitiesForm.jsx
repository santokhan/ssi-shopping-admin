...
const AmenitiesForm = () => {
  ...
  const { storeFormData, postData } = useContext(PropertyFormContext);
  ...
  const onSubmit = (e) => {
    ...
    formData.append('amenities', JSON.stringify(formState));

    storeFormData('amenities', formData);
        ...
        {amenities.map((amenity) => (
          <CheckBoxContainer
            ...
            onChange={() => {
              ...
              const existingAmenity = formState.find(
