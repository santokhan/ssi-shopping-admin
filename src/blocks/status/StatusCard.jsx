    ...
    return (
        <div className="flex min-w-[260px] flex-1 items-center justify-between gap-8 rounded-lg bg-white p-4 sm:p-6 lg:p-8 shadow">
            <div>
                ...
                <h2 className="line-clamp-1 text-3xl lg:text-4xl font-bold text-slate-900">{amount}</h2>
            </div>
            <div className="">
...
const StatusCard = () => {
    const items = [
        ...
        },
        {
            title: 'All Properties',
            amount: 583,
            icon: <Heart className="h-8 lg:h-10 w-8 lg:w-10" />
        },
        {
            title: 'All Properties',
            amount: 583,
            icon: <TrendUp className="h-8 lg:h-10 w-8 lg:w-10" />
        },
        {
            title: 'All Properties',
            amount: 583,
